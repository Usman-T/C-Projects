// Enter your code below the lines of the
...
namespace estate_executor
{
  ...
  {
    return khan::bank_number_part(secret_modifier) + zhang::bank_number_part(secret_modifier) +
  ...
  {
    int reds =
        khan::red::code_fragment() + zhang::red::code_fragment() + garcia::red::code_fragment();
    int blues =
